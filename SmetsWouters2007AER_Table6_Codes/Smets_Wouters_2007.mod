...
load PARAMFILE;
set_param_value('std_ea',std_ea);
set_param_value('std_eb',std_eb);
set_param_value('std_eg',std_eg);
set_param_value('std_eqs',std_eqs);
set_param_value('std_em',std_em);
set_param_value('std_epinf',std_epinf);
set_param_value('std_ew',std_ew);


set_param_value('crhoa',crhoa);
set_param_value('crhob',crhob);
set_param_value('crhog',crhog);
set_param_value('crhoqs',crhoqs);
set_param_value('crhoms',crhoms);
set_param_value('crhopinf',crhopinf);
set_param_value('crhow',crhow);
set_param_value('cmap',cmap);
set_param_value('cmaw',cmaw);
set_param_value('csadjcost',csadjcost);
set_param_value('csigma',csigma);
set_param_value('chabb',chabb);
set_param_value('cprobw',cprobw);
set_param_value('cindw',cindw);
set_param_value('csigl',csigl);
set_param_value('cprobp',cprobp);
set_param_value('cindp',cindp);
set_param_value('czcap',czcap);
set_param_value('cfc',cfc);
set_param_value('constepinf',constepinf);
set_param_value('constebeta',constebeta);
set_param_value('constelab',constelab);
set_param_value('ctrend',ctrend);
set_param_value('cgy',cgy);
set_param_value('calfa',calfa);
set_param_value('crpi',crpi);
set_param_value('crr',crr);
set_param_value('cry',cry);
set_param_value('crdy',crdy);
...
stoch_simul(periods=0, irf=0) dy pinfobs;
