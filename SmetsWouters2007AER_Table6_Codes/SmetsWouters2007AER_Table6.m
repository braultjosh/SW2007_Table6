...
load usmodel_hist_dsge_f19_7_143_mode
param_vec(15:36,1) = xparam1(15:36); % structural model parameters equal to post-1984 modes
load usmodel_hist_dsge_f19_7_7158_mode
param_vec(1:14,1) = xparam1(1:14); % shock stds and persistence equal to pre-1979 modes
PARAMFILE
dynare Smets_Wouters_2007
...
load usmodel_hist_dsge_f19_7_7158_mode
param_vec(15:36,1) = xparam1(15:36); % setting structural parameters to pre-1979
load usmodel_hist_dsge_f19_7_143_mode
param_vec(1:14,1) = xparam1(1:14); % setting shock processes (stds and persistence) to post-1984
